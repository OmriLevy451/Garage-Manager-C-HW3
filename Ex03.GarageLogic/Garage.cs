...
namespace Ex03.GarageLogic
{
    public class Garage
    {
        ...
        private readonly Dictionary<Vehicle, CarOwnerInfo> r_ClientInfo = new Dictionary<Vehicle, CarOwnerInfo>();
         ...
         public void AddVehicle(Vehicle i_Vehicle, CarOwnerInfo i_ClientInfo)
         {
            //write
         }
